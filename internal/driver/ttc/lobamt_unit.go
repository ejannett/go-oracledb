...
func resolveLobAmtUnit(charSet driverCommon.UB2) (lobAmtUnit, error) {
	switch charSet {
	...
	default:
		return lobAmtUnknown, common.NewOracleError(
			oracleErrors.UnsupportedCharacterSet,
			nil,
			charSet,
		)
	}
...
func newLobAmtPolicy(driverCS, ncharCS driverCommon.UB2) lobAmtPolicy {
	return lobAmtPolicy{
		driverCS: driverCS,
		ncharCS:  ncharCS,
	}
