...
const (
	...
	// SessionContextValueRetrievalError indicates that a required session
	// context string value could not be retrieved or was empty.
	SessionContextValueRetrievalError ErrorCode = "OGD-00203"
